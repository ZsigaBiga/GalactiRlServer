...
#define WFAlpha 0.25 // [0.00 0.05 0.10 0.15 0.20 0.25 0.30 0.35 0.40 0.45 0.50 0.55 0.60 0.65 0.70 0.75 0.80 0.85 0.90]
...
void WaterFog(inout vec3 color, in SurfaceStruct surface, in MCLightmapStruct mcLightmap)
{
	...
	if (surface.mask.water > 0.5 || isEyeInWater > 0)
	{
		...
		vec3 waterFogColor = vec3(RWATER, GWATER, BWATER/255.0f) * WFAlpha; //clear water
