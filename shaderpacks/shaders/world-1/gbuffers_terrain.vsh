...
#define ANIMATION_SPEED 0.25f //[0.25f 0.3f 0.35f 0.4f 0.45f 0.5f]
...
void main() {
	...
	if  (  mc_Entity.x == 10031.0
		...
		|| mc_Entity.x == 10038.0f 	//Rose
		|| mc_Entity.x == 10037.0f 	//Flower
	...
	//lava
	if (mc_Entity.x == 10010 || mc_Entity.x == 10011) {
